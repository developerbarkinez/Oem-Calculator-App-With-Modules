...
const UIController = (function () {
    ...
    return {
        ...
        clearWarnings: function () {
            const items = document.querySelectorAll(Selectors.productCard).style.display = 'none';
        ...
        showTotal: function (total) {
            ...
            document.querySelector(Selectors.totaltl).textContent = total * 10.0;
        },
        ...
        deleteProduct: function () {
            let items = document.querySelector(Selectors.productListItems);
            items.forEach(function (item) {
                if (item.classList.contains('bg-warning')) {
                    item.remove();
                }
...
const AppController = (function (ProductCtrl, UICtrl, StorageCtrl) {
    ...
    const productAddSubmit = function (e) {
        ...
        if (productName !== '' && productPrice !== '') {
            ...
            //calculate the total Dolar/TL information
            const total = ProductCtrl.getTotal();
